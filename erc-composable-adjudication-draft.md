...
- Definition and resolution attestations MUST be irrevocable: their EAS schemas MUST be registered with revocability disabled. A resolution whose content could be revoked after `Resolved` would defeat the standard's load-bearing guarantee, leaving consumers holding an immutable pointer to a repudiated statement.
